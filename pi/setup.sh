...
echo ""
echo "OPTIONAL: To access your PrintPulse from the internet"
echo "(no static IP or port forwarding needed), set up a"
echo "Cloudflare Tunnel:"
echo ""
echo "  bash $PP_HOME/PrintPulse/pi/setup-cloudflare-tunnel.sh"
echo ""
